# Full-scale TSGM PM25 run: data prep -> train -> recursive PC sampling (n_steps=1000)
# -> 10-seed discriminative/predictive/t-SNE evaluation. Iteration counts, score-net type,
# SDE, etc. all come from configs/pm25.yaml. See docs/reproduction_plan.md.
...
$Config = "configs/pm25.yaml"
$CkptDir = "outputs/checkpoints/pm25_full"
...
Write-Host "== M6: preparing PM25 data =="
& $Python scripts/prepare_data_pm25.py `
    --out data/processed/pm25 `
    --T 24
